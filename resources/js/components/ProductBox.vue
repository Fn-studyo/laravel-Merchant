...
<div class="products-side">
    <section class="product spad">
        <div align="left" class="py-3 px-4">
            <p class="text-xl">My products</p>
        </div>
        <br>
                    <div class="container">
                    <div class="row product__filter" id="MixItUp7D60D2">
...
<style scoped>
@import url('http://127.0.0.1:8000/css/bootstrap.min.css');
@import url('http://127.0.0.1:8000/css/style.css');
</style>
<script>
    export default {
        name: 'ProductBox'
