    ...
    <header class="h-24 sm:h-32 flex items-center">
        <div class="container mx-auto px-6 sm:px-12 flex items-center justify-between">
            <div class="text-black font-black text-2xl flex items-center">
                <jet-authentication-card-logo /> <span class="mx-4">Branchr</span>
            </div>
            <div class="flex items-center">
                <nav class="text-black text-lg hidden lg:flex items-center">
                    ...
                    <div v-if="canLogin">
                    <inertia-link class="py-2 px-6 flex hover:text-blue-500"  v-if="$page.props.user" href="/dashboard">
                        Dashboard
                    </inertia-link>
                        <template v-else>
                        <inertia-link class="py-2 px-6 flex hover:text-blue-500" :href="route('login')">
                        Login
                    </inertia-link>
                        </template>
                    </div>
